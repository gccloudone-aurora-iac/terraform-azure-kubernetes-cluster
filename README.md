...
| 2025-10-14 | v2.0.1  | Add variable `support_plan`. Change default for `sku_tier` to `Premium`                                                |
...
| 2026-05-22 | v3.0.0  | Rename `custom_ca` to `custom_ca_trust_certificates_base64` and change type to `list(string)`                        |
